    ...
    <div>
      <div className="container">
        <div className={`row mt-4 ${styles.card}`}>
          ...
          <div className="right-side col-md-6 col-sm-12 pt-4">
            <div className="col-md-12">
              <h2 id={styles.pageLabel} style={{ fontWeight: 600 }}>
                Halo, Pewpeople!
              </h2>
              <h6 className="mt-3">
            ...
            <form className="col-md-12 pt-4" onSubmit={handleRegister}>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  name="worker_email"
                  value={register.worker_email}
                  onChange={handleChange}
                />
              </div>
              <div className="form-group">
                <label htmlFor="exampleInputPhone1" id={styles.label}>
                  No. Handphone
                </label>
                <input
                  type="text"
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  name="worker_pass"
                  value={register.worker_pass}
                  onChange={handleChange}
                />
              </div>
              <div className="form-group">
                <label htmlFor="exampleInputPassword2" id={styles.label}>
                ...
                <input
                  ...
                  value={register.worker_confirm_pass}
                  onChange={handleChange}
                />
              </div>
              <div className="form-group pt-2">
                <button className="btn btn-block" id={styles.btnLog} type="submit" title="register">
