...
const ModalEditAvatarWorker = ({ worker_id }) => {
  ...
  const handleSubmit = (e) => {
    ...
    formData.append("worker_photo", photo);

    axios
      .put(`${process.env.NEXT_PUBLIC_API}/worker/profilephoto/${worker_id}`, formData)
      .then((response) => {
...
export default ModalEditAvatarWorker;
